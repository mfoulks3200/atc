...
export function buildSystemPrompt(
  ...
  return [
    ...
    "",
    "```",
    "atc_craft_report_vector({ vectorName: \"<exact name>\", evidence: \"<what you verified>\" })",
    "```",
    "Only the next Pending vector in sequence can be reported — vectors must be passed in order.",
    "",
    ...
    "### Before you transmit",
    "",
    `Read recent intercom history first: \`curl ${craftBase}/intercom\` or call \`atc_get_context()\`.`,
